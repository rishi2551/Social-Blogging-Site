      ...
      {showfirstcode ? (
        <div className="background">
          <div className="cover-image">
            <img src={`https://adventure-archive-76s9.onrender.com/${Profile.user?.coverPhoto}`} className="cover-img" alt="" />
          </div>
      ...
      >
        <div>
         {posts?.map((item, index) => {
            return <SwiperSlide>
            <img src={`https://adventure-archive-76s9.onrender.com/${item.image}`} />
          </SwiperSlide>
          })}</div>
